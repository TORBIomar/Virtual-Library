    ...
    <div className="min-h-screen bg-aurora grid place-items-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="glass rounded-2xl p-8 animate-fade-in">
          ...
          <p className="text-sm text-muted-foreground mb-6">Sign in to continue your reading.</p>
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-shine relative w-full py-3 rounded-xl bg-primary text-primary-foreground font-medium hover:bg-primary/90 transition-all shadow-glow disabled:opacity-60 inline-flex items-center justify-center gap-2"
            >
          ...
          <div className="mt-6 text-xs text-center text-muted-foreground">
            Demo: <code className="text-foreground">reader@smartlib.dev</code> or <code className="text-foreground">admin@smartlib.dev</code> (any password)
          </div>
    ...
    <label className="block">
      ...
      <div className="mt-1.5 relative">
        ...
        <input
          ...
          required
          className="w-full bg-input rounded-lg pl-10 pr-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-ring transition-shadow"
        />
      </div>
    </label>
  );
