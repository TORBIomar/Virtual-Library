    ...
    <div className="min-h-screen bg-aurora noise-overlay">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-12 pb-20">
        <header className="mb-10 animate-fade-in">
          <span className="text-[11px] uppercase tracking-[0.25em] text-muted-foreground font-medium">Library</span>
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
          <div className="relative md:w-80">
            ...
            <input
              ...
              className="w-full bg-input rounded-lg pl-10 pr-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-ring/50 border border-transparent focus:border-white/10 transition-all"
            />
          </div>
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-medium transition-all cursor-pointer ${
                  cat === c
                    ...
                    : "glass-strong hover:bg-surface-elevated text-muted-foreground hover:text-foreground"
                }`}
              >
                {c}
              </button>
