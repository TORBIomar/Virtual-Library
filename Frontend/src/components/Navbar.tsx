    ...
    <header className="sticky top-0 z-50 glass-strong">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to={user ? "/library" : "/"} className="flex items-center gap-2.5 group">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-white/10 to-white/[0.03] flex items-center justify-center group-hover:from-white/15 group-hover:to-white/[0.05] transition-all border border-white/[0.06]">
          ...
          {user ? (
            <>
              <div className="hidden sm:flex items-center gap-2.5 text-sm">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-white/15 to-white/[0.04] flex items-center justify-center text-xs font-semibold text-white/80 border border-white/[0.08]">
